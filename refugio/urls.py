...
urlpatterns = [
    ...
    url(r'^mascota/', include('refugio.apps.mascota.urls', namespace='mascota')),
    url(r'^adopcion/', include('refugio.apps.adopcion.urls', namespace='adopcion')),
    url(r'^usuario/', include('refugio.apps.usuario.urls', namespace='usuario')),
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$',password_reset_confirm,{'template_name':'password_reset_confirm.html'},
